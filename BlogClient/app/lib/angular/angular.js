 ...
 * 
 * <pre>
 * var blogSpace = angular.module('blogSpace', []);
 * blogSpace.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://blogSpace.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://blogSpace.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('blogSpace', []).config(function($sceDelegateProvider) {
 ...
 *        'http://blogSpace.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="blogSpaceController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("blogSpaceController", function blogSpaceController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('blogSpaceWithSceDisabledblogSpace', []).config(function($sceProvider) {
