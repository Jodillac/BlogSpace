 ...
 *
 * <pre>
 *   blogSpaceDev = angular.module('blogSpaceDev', ['blogSpace', 'ngMockE2E']);
 *   blogSpaceDev.run(function($httpBackend) {
...
if(window.jasmine || window.mocha) {
   ...
   * <pre>
   *
   *   angular.module('blogSpacelicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('blogSpace', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('blogSpacelicationModule'));
   *
   *
